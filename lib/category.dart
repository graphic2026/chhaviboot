...
//     }else{
//       url =
//       "https://newsapi.org/v2/everything?q=$query&sortBy=publishedAt&apiKey=a977254fcdf24ea0b0f4ee05570bc60e";
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      margin: EdgeInsets.symmetric(vertical: 15),
                      child: Text(widget.Query, style: TextStyle( fontSize: 39,color: Colors.white
                      ),),
                    ),
                  ],
                ),
